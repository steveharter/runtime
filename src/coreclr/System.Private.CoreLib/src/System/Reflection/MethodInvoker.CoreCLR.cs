...
namespace System.Reflection
{
    public partial class MethodInvoker
    {
        ...
        private unsafe object? InterpretedInvoke(object? obj, IntPtr* arguments, bool isConstructor)
        {
            return RuntimeMethodHandle.InvokeMethod(obj, (void**)arguments, _signature, isConstructor);
        }
    }
}
