...
namespace Internal.Reflection.Core.Execution
{
    ...
    public abstract class ExecutionEnvironment
    {
        ...
        //==============================================================================================
        public abstract Internal.Reflection.Core.Execution.MethodInvoker TryGetMethodInvoker(RuntimeTypeHandle declaringTypeHandle, QMethodDefinition methodHandle, RuntimeTypeHandle[] genericMethodTypeArgumentHandles);
        ...
        public abstract IntPtr GetDynamicInvokeThunk(Internal.Reflection.Core.Execution.MethodInvoker invoker);

        //==============================================================================================
        // Non-public methods
        //==============================================================================================
        internal Internal.Reflection.Core.Execution.MethodInvoker GetMethodInvoker(RuntimeTypeInfo declaringType, QMethodDefinition methodHandle, RuntimeTypeInfo[] genericMethodTypeArguments, MemberInfo exceptionPertainant, out Exception exception)
        {
            exception = null;
            ...
            Internal.Reflection.Core.Execution.MethodInvoker methodInvoker = TryGetMethodInvoker(typeDefinitionHandle, methodHandle, genericMethodTypeArgumentHandles);
            if (methodInvoker == null)
                exception = ReflectionCoreExecution.ExecutionDomain.CreateNonInvokabilityException(exceptionPertainant);
            return methodInvoker;
        }

        protected Internal.Reflection.Core.Execution.MethodInvoker GetMethodInvoker(MethodInfo methodInfo)
        {
